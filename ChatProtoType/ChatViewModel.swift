...
class ChatViewModel: ObservableObject {   // ✅ conform to ObservableObject
    // MARK: - Properties
    @Published var conversations: [Conversation] = []
    @Published var selectedConversation: Conversation?   // active chat
    @Published var newMessage: String = ""
    @Published var username: String = "Me"
    ...
    // MARK: - Conversation CRUD
    func addConversation(title: String = "New Chat") {
        let conversation = Conversation(title: title)
        conversations.append(conversation)
        saveConversations()
    }
